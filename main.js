...
const starts = async (Devil = new WAConnection()) => {
	...
	console.log(color('[ 𝗜𝗦𝗠𝗔𝗜𝗟𝟴𝟯𝟮 𝗜🅓 ]', 'cyan'), color('Owner is online now!', 'green'))
	console.log(color('[ 𝗜𝗦𝗠𝗔𝗜𝗟𝟴𝟯𝟮 𝗜🅓 ]', 'cyan'), color('Welcome back, Owner! Hope you are doing well~', 'green'))
