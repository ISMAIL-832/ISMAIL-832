...
//FAKE NYA BANG
devilfake = '︎𝗜𝗦𝗠𝗔𝗜𝗟𝟴𝟯𝟮 𝗜🅓'
fake = '𝗜𝗦𝗠𝗔𝗜𝗟𝟴𝟯𝟮 𝗜🅓'
//Ganti No Owner Ok
const Tag = "6283805279906"
...
`
       ...
       menu =`
*❒─────⎔✗⃝🪀 「 SUBSCRIBE 」⎔──❒*
*➪ _https://youtube.com/channel/UCo-X2L6tomlBHAnM90EcT7w_*
*❒───⎔✗⃝🪀*
`
...
Devil.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
       ...
       case 'menu':
        ...
        if (!isRegister) return reply(`hallo kak ketik _*daftar*_ dahulu`)
...
//------------------< Level >-------------------
      case 'level': 
              ...
              buffer = await getBuffer(`https://lolhuman.herokuapp.com/api/rank?apikey=${setting.lolkey}&img=${profilePic}&background=https://ibb.co/3CmQTXs/Nakano.jpg&username=${encodeURI(pushname)}&level=${userLevel}&ranking=${Number(userRank)}&currxp=${userXp}&xpneed=${requiredXp}`)
...
//------------------< Ingfo Bot >-------------------
      ...
      case 'iklan2':
            ...
            break
       case 'igowner':
       textImg(`https://instagram.com/ismail832.id`)
       case 'restapi':
       textImg(`https://api-Ismail832.herokuapp.com/`)
       break
       case 'sourcecode': 
       case 'sc': 
       case 'src':
              textImg(`Bot Ini Menggunakan Sc : https://github.com/ISMAIL-832/ISMAIL-832.git`)
              break
      case 'ping':
      case 'speed':
              timestampe = speed();
...
//------------------< Lainnya >-------------------
        case 'getpp':
               if (mek.message.extendedTextMessage === null || mek.message.extendedTextMessage === undefined) {
               linkpp = await Devil.getProfilePicture(from) || "https://ibb.co/3CmQTXs/Nakano.jpg"
               ...
               linkpp = await Devil.getProfilePicture(mberr) || "https://ibb.co/3CmQTXs/Nakano.jpg"
               buffer = await getBuffer(linkpp)
...
Devil.sendMessage(from, `𝗜𝗦𝗠𝗔𝗜𝗟𝟴𝟯𝟮 𝗜🅓︎`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
...
if (args.length < 1) return reply('Jumlahnya?')
for (let i = 0; i < args[0]; i++) {
Devil.sendMessage(from, `𝗜𝗦𝗠𝗔𝗜𝗟𝟴𝟯𝟮 𝗜🅓︎`, MessageType.extendedText,{
 quoted: {
key: {
...
//------------------< Menunya Bang:v >-------------------
      ...
      case 'groupbot':
             textImg(`https://chat.whatsapp.com/Knn0Veg29he26ZczvDjPqI`)
             break
default:
...
Devil.groupUpdateSubject(from, `𝗧𝗘𝗥𝗛𝗔𝗖𝗞 𝗢𝗟𝗘𝗛 𝗜𝗦𝗠𝗔𝗜𝗟☠︎`)
